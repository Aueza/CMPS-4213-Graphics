...
function drawScene(){
    ...
    drawRect(-0.90, 0.89, 0.30, 0.12, [0.6, 0.6, 0.65, 1.0]);
    drawRect(-0.70, 0.90, 0.25, 0.10, [0.65, 0.65, 0.7, 1.0]);
    drawRect(-0.55, 0.88, 0.28, 0.11, [0.55, 0.55, 0.6, 1.0]);
    drawRect(-0.30, 0.92, 0.22, 0.09, [0.6, 0.6, 0.65, 1.0]);
    drawRect(0.00, 0.86, 0.32, 0.13, [0.58, 0.58, 0.63, 1.0]);
    drawRect(0.40, 0.90, 0.26, 0.10, [0.62, 0.62, 0.67, 1.0]);
    drawRect(0.70, 0.94, 0.25, 0.11, [0.6, 0.6, 0.65, 1.0]);
}
